...
print("Timezone Aware Train set size:", len(train_df))
print("Timezone Aware Test set size:", len(test_df))
...
if len(y_pred) > 0:
    ...
    print("Min Predicted Probability:", np.min(y_prob))
    print("Mean Predicted Probability:", np.mean(y_prob))
    print("Unique Predictions Counts:", pd.Series(y_pred).value_counts())
