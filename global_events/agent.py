...
from .tools import plot_stock_data, get_global_events, search_recent_events
...
3. Call `plot_stock_data` to render the sophisticated visual overlay. The plotting tool will automatically handle the visual regime shading.
...
""",
    ...
    tools=[plot_stock_data, get_global_events, search_recent_events]
)
